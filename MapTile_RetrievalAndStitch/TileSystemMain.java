...
public class TileSystemMain {
	...
	public void run() throws IOException {
		...
		while (flag) {
			...
			boolean lol = Error(tile1, tile2, level);
			if (lol == true)
				level--;
			else
				flag = false;
		...
		// Downloading images at the right level of detail and stitching them
		// together.
	 ...
	 * 
	 * @param tile1,
	 *            an integer array containing the tile coordinates of the first
	 *            point at the given level of detail.
	 * @param tile2,
	 *            an integer array containing the tile coordinates of the second
	 *            point at the given level of detail.
	 * @param level,
	 *            the level of detail.
	 ...
	 * 
	 * @param, one the first image. @param, two the second image.
	 * 
	...
	/**
	 * A method to download images at a particular level of detail and stitch
	 * them together.
	 * 
	 * @param tile1,
	 *            an integer array containing the tile coordinates of the first
	 ...
	 *            the level of detail.
	 * @param rows,
	 *            the number of rows in the stitched image.
	 * @param columns,
	 *            the number of columns in the stitched image.
	 * @throws IOException
	 */
